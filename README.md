...
* https://github.com/d3/d3-collection/blob/v1.0.7/README.md#nest_sortValues
* https://codepen.io/tbbooher/pen/JjPROZd
* [color details](https://www.d3-graph-gallery.com/graph/custom_color.html)
* [I used this as an example](https://www.d3-graph-gallery.com/graph/treemap_custom.html)
* [object format reference](https://developers.google.com/datastudio/visualization/library-reference#objectformat_reference)

## ToDo

* https://developers.google.com/datastudio/visualization/local-dev
* https://developers.google.com/datastudio/visualization/manifest-reference
